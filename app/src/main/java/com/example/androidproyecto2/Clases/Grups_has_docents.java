...
public class Grups_has_docents
{
    private Curs cursos;
    private Grup grups;
    ...
    public Grups_has_docents(Curs cursos, Grup grups, Usuari usuaris, int grups_id, int usuaris_id, int curs_id) {
        this.cursos = cursos;
        this.grups = grups;
